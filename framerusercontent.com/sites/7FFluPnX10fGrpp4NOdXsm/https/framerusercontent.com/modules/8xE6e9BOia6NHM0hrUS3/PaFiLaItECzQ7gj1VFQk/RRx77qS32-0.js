var t, e = Object.create,
    ...
    p = class {
        ...
        constructor(t) {
            this.bytes = t, c(this, "offset", 0), c(this, "view"), c(this, "decoder", new TextDecoder), this.view = v(this.bytes);
        }
    };
...
var F = class {
    ...
    ensureLength(t) {
        ...
        r.set(this.bytes), this.bytes = r, this.view = v(r);
    }
    writeUint8(t) {
...
function tb(t, e) {
    ...
    t.read = function(t) {
        ...
        switch (t.type) {
            ...
            case P.RichText:
                return I(e.type === P.RichText), tp(t, e);
            case P.VectorSetItem:
...
var tN = class {
        ...
        queryContains(t, e, r) {
            return this.findItems(t, r, t => {
                if (t ?.type !== y.String || e.value ?.type !== y.String) return !1;
                let r = t.value,
                    n = e.value.value;
    ...
    tP = class {
        ...
        constructor(t) {
            this.options = t, c(this, "id"), c(this, "schema"), c(this, "indexes"), c(this, "resolveRichText"), c(this, "resolveVectorSetItem"), c(this, "chunks"), this.chunks = this.options.chunks.map((t, e) => new tO(e, t)), this.schema = t.schema, this.indexes = t.indexes, this.resolveRichText = t.resolveRichText, this.resolveVectorSetItem = t.resolveVectorSetItem, this.id = t.id;
        }
    };
export {
