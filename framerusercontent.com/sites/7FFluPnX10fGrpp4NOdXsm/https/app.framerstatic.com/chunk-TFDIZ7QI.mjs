...
function useAnimate() {
  ...
  const { skipAnimations } = useContext15(MotionConfigContext);
  const animate2 = useMemo9(() => createScopedAnimate({ scope, reduceMotion, skipAnimations }), [scope, reduceMotion, skipAnimations]);
  useUnmountEffect(() => {
...
function usePresenceData() {
  const context = useContext16(PresenceContext);
...
function useInvertedScale(scale2) {
  ...
  const { visualElement } = useContext17(MotionContext);
...
import { forwardRef as forwardRef3, useContext as useContext18 } from "react";
...
function ReorderItemComponent({ children, style: style2 = {}, value, as = "li", onDrag, onDragEnd, layout: layout2 = true, ...props }, externalRef) {
  const Component3 = useConstant(() => motion[as]);
  const context = useContext18(ReorderContext);
  const point2 = {
...
//# sourceMappingURL=chunk-TFDIZ7QI.mjs.map
