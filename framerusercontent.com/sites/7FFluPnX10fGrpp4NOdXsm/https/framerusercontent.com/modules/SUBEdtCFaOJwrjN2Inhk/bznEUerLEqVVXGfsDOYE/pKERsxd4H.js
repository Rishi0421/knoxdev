...
const css = [`.framer-c2uAX { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
/**
 ...
 */
const Icon = withCSS(Component, css, "framer-c2uAX");
